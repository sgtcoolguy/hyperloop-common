...
describe('#types', function(){
	...
	it('struct Foo', function() {
		...
		preamble.should.not.be.empty;
		preamble[0].should.equal('struct Foo * value$ = (struct Foo *)malloc(sizeof(struct Foo));');
		preamble[1].should.equal('memcpy(value$,&value,sizeof(struct Foo));');
		cleanup.should.be.empty;
	...
	it("CGRect", function() {
		...
		preamble.should.not.be.empty;
		preamble[0].should.equal('CGRect * value$ = (CGRect *)malloc(sizeof(CGRect));');
		preamble[1].should.equal('memcpy(value$,&value,sizeof(CGRect));');
		cleanup.should.be.empty;
		declare.should.not.be.empty;
	...
	it('__CFAllocator', function() {
		...
		declare.should.not.be.empty;
		preamble.should.not.be.empty;
		preamble[0].should.equal('struct __CFAllocator * value$ = (struct __CFAllocator *)malloc(sizeof(struct __CFAllocator));');
		preamble[1].should.equal('memcpy(value$,&value,sizeof(struct __CFAllocator));');
	...
	it('_opaque_pthread_attr_t', function(){
		...
		preamble.should.not.be.empty;
		preamble[0].should.equal('_opaque_pthread_attr_t * value$ = (_opaque_pthread_attr_t *)malloc(sizeof(_opaque_pthread_attr_t));');
		preamble[1].should.equal('memcpy(value$,&value,sizeof(_opaque_pthread_attr_t));');
		cleanup.should.be.empty;
		declare.should.not.be.empty;
