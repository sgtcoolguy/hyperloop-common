...
Hook.prototype.createHook = function createHook(name, ctx, fn) {
	...
	return function () {
		...
		// add any wildcards
		hooks.pre_all.length && (pres = pres.concat(hooks.pre_all));
		hooks.post_all.length && (posts = posts.concat(hooks.post_all));
